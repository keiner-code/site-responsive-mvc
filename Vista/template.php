...
class Template{
   ...
   public function Template_html($subtitle){
    ...
    function Template_nav($img_users,$name_users,$type_users,$date_Users){
       echo'<main id="container">
        <nav id="nav-header" class="col-md-12 col-ms-2">
            ...
            if ($date_Users) {
               echo'<select name="date-users" id="" class="btn-dropdowns">
                ...
                echo'<div class="Link-Login-Users">
                <a href="./Vista/Login.php" >Iniciar Session</a>
                <a href="http://">Cerrar Session</a></div>';
            }
           echo' </div>
        </div>
        </nav>';
